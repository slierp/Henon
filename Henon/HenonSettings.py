...
class HenonSettings(QtWidgets.QDialog):
    ...
    def __init__(self, _parent):
        ...
        self.hena.setMaximum(4.0)
        self.hena.setMinimum(-4.0)
        ...
        self.hena_start.setMaximum(4.0)
        self.hena_start.setMinimum(-4.0)
        ...
        self.hena_stop.setMaximum(4.0)
        self.hena_stop.setMinimum(-4.0)
